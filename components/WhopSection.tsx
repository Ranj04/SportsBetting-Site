    ...
    <section className="py-20 px-4 relative overflow-hidden bg-gradient-to-b from-carbon-dark via-carbon/50 to-carbon-dark">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-gold/5 border border-gold/20">
            <svg className="w-4 h-4 text-gold flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
            </svg>
            <p className="text-silver text-sm">
              <span className="text-gold font-medium">AI Model picks</span> available at a slightly higher tier than premium
            </p>
          </div>
        </div>

        {/* Bottom Trust Elements */}
        <div className="flex flex-wrap justify-center gap-8 mt-8 text-silver/60 text-sm">

  ...
  return (
    <section className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="card-metallic p-8 md:p-12 border-gold/30 text-center">
          {/* Headline */}
          ...
          <p className="text-silver text-lg mb-8 max-w-2xl mx-auto">
            Join thousands of members who are already cashing in on our expert picks.
            Free picks on Twitter. <span className="text-green-400">Free Discord community</span> with daily insights.
          </p>
          ...
          {/* Trust badges */}
          <div className="mt-8 flex flex-wrap justify-center gap-6 text-silver text-sm">

...
export default function AboutPage() {
  ...
  return (
    <PageLayout>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="border-t border-silver/10 pt-10">
            <div className="text-center">
              <p className="text-silver-dark text-xs uppercase tracking-widest mb-3">
                Designed & Developed by
              </p>
              <h3 className="font-display text-lg md:text-xl font-semibold text-white mb-1">
                Ranjiv Jithendran
              </h3>
              <p className="text-silver-dark text-xs mb-5">
                for Sus Sweat Shop
              </p>
              <div className="flex justify-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#0A66C2]/10 border border-[#0A66C2]/20
                            text-[#0A66C2] hover:bg-[#0A66C2] hover:text-white transition-all duration-300 text-xs font-medium"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-silver/15
                            text-silver hover:bg-white hover:text-carbon-dark transition-all duration-300 text-xs font-medium"
                >
                  <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
